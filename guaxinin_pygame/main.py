...
from scenery import draw_scenery, init_assets
...
try:
    ...
    city_name = "Julio de Castilhos, Brazil"
    southern = True
    ...
    show_test = False
    show_help = False
    show_info = True   # I key toggles weather + HUD info panels
    fullscreen = False
    ...
    while running:
        ...
        draw_scenery(screen, WIDTH, HEIGHT, season, hour, day, weather, moon_phase)
        flock.draw(screen)
        ...
        if show_info:
            ...
            # city_rect still needs to be defined for click handling
            wpw = 280
            wpx = 12
            wpy = 8
            city_rect = pygame.Rect(wpx, wpy, wpw, 30)
            # Show tiny "I: info" hint
            hint_surf = font_small.render("[I] info", True, (80, 90, 120))
            screen.blit(hint_surf, (14, 10))
